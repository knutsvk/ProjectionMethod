...
\begin{figure*}[t]
    ...
    {
        \pgfplotstableread{../Results/psi_N33_Re\Re.out}{\psi}
        ...
        \begin{tikzpicture}
            ...
            [
                ...
                table[each nth point=126]{../Results/vec_N33_Re\Re.out};
                \addplot[white, quiver={u=\thisrow{u},v=\thisrow{v}, scale arrows=0.5}, -stealth]
                table[each nth point=130]{../Results/vec_N33_Re\Re.out};
            \end{axis}
        \end{tikzpicture}
    }
